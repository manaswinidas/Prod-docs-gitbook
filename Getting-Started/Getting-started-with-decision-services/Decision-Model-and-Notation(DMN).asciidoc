...
link: DMN-subtree/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-and-Notation-DMN/Decision-Model-and-Notation-DMN.asciidoc [Decision Model and Notation]
